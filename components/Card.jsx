...
export const Card = ({ title, content, page, code, images, description }) => {
    return (
        <div className='mt-10'>
            <div className='flex flex-wrap w-5/6 h-full lg:h-80 bg-[#F5F5F5] dark:bg-cyan-950 rounded-xl mx-auto drop-shadow-md'>
                ...
                <div className=' lg:w-1/2 w-full font-semibold dark:font-normal'>
