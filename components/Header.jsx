        ...
        <>
            <div id='aboutMe' className='grid justify-items-center  pt-5 '>
                ...
                <div className='w-2/4 text-xl mt-10'>
                    <p className=' mb-10'>I am a passionate <span className='text-[#3B94A8] '>front-end developer </span> with a deep passion for <span className='text-[#3B94A8]'>technology</span> and programming. Currently, I am in my final year of Computer Science bachelor, I'm 22 years old and I live in Chile. My primary focus is on web development and cloud technologies, two constantly evolving areas that inspire me to learn and grow continuously.
                    </p>
